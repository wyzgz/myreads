    ...
    return (
      <div className="bookshelf">
        ...
        <div className="bookshelf-books">
          <BookList bookList={currentlyReading} update = {this.props.update}/>
        </div>
        <h2 className="bookshelf-title">Want to Read</h2>
        <div className="bookshelf-books">
          <BookList bookList={wantToRead} update = {this.props.update}/>
        </div>
        <h2 className="bookshelf-title">Read</h2>
        <div className="bookshelf-books">
          <BookList bookList={read} update = {this.props.update}/>
        </div>
      </div>
    )
  }
